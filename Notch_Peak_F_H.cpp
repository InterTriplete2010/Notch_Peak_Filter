...
//Overload of the Notch Filter allowing the user to choose the dB level of the bandwidth
std::vector<std::vector<double>> Notch_Peak_F::iirnotch_cpp(double WO, double BW, double AB)
{
...
std::vector<std::vector<double>> Notch_Peak_F::iircomb_cpp(double order, double BW, double AB, std::string type_filt)
{
